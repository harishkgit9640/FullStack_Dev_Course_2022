  ...
  <div className="mt-10">
    {links.map((item) => (
      <NavLink
        key={item.name}
        to={item.to}
        className="flex fle-row justify-start items-center my-8 text-sm font-medium text-gray-400 hover:text-cyan-400"
  ...
  return (
    <>
      <div className="md:flex hidden flex-col w-[240px] py-10 px-4 bg-[#191624]">
        <img src={logo} alt="menu" className="w-full h-14 object-contain" />
        <NavLinks />
      </div>
